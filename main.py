...
metin="Yazilim Gelistirici Yetistirme Kampi" #String veri tipidir
yil=2023 #İnteger veri tipidir
...
# if user == Kariyer:
#     print("Kariyeriniz için aşağıdaki formu doğru ve samimi olarak doldurunuz")

# elif user== Sık Sorulan Sorular :
#     print("Aşağıda merak ettiğiniz konularda soru ve cevapları bulabilirsiniz")

# elif user== Giriş Yap:
#     print("Lütfen Kullanıcı Adı ve Şifrenizi Giriniz")

# elif user== Kayıt Ol :
#     print("Sitemize Kayıt Olabilmek İçin Aşağıdaki Forma Bilgilerinizi Giriniz")
